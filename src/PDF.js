...
const PDF = () => {
  ...
  return (
    <div className="max-w-[1400px] mx-auto flex flex-col space-y-10 mb-5 justify-center py-5 items-center flex-wrap">
      <h1 className="font-semibold text-2xl mb-5">Resume Generator</h1>
